...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>/resources/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <link rel="stylesheet" href="<?=base_url();?>/resources/admin/dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?=base_url();?>/resources/admin/bower_components/morris.js/morris.css">
  <!-- jvectormap
  <link rel="stylesheet" href="<?=base_url();?>/bower_components/jvectormap/jquery-jvectormap.css"> -->
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?=base_url();?>/resources/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker 
