...
<?php 
    ...
    ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><div class="btn-group-vertical">
                                                    <a href="<?= base_url('Admin/editabout/') . $row->id; ?>"> <button type="button" class="btn btn-block btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button> </a>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12" >
                            ...
                            <a href="<?= base_url() . 'admin/addabout'; ?>" class="btn btn-success pull-right" style="float: left!important;width:100px;"><i class="fa fa-plus"></i> Add</a>
   ...
   <script type="text/javascript">
    function show_delete_confirm(id)
    {
        ...
        if (r == true) {
            window.location = "<?php echo base_url(); ?>admin/del_about/" + id;
        }
    }
</script>
 <script>
